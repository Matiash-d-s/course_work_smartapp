...
function* script(r) {
  ...
  function afterCorrect() {
    updateState();
    state.score++;
    rsp.msg = choice(['Правильно!', 'Угадали!', 'Молодец!']);// + state.country.name;
  }
  ...
  updateState();
  rsp.msg = 'Добро пожаловать в игре Угадай флаг. Вам будут показаны флаги различных стран. ' +
    'Вы должны угадать, к каким странам они относятся. Если возникнут вопросы, скажите Помощь. А вот и первый флаг';
  rsp.msgJ = 'Приветствую в игре Угадай флаг. Тебе будут показаны флаги различных стран. ' +
    'Ты должны угадать, к каким странам они относятся. Если возникнут вопросы, скажи Помощь. А вот и первый флаг.';
  yield rsp;
